...
export function NewNoteCard({ onNoteCreated }: NewNoteCardProps) {
  ...
  function handleStartRecording() {
    ...
    speechRecognition.continuous = true // Ele não vai parar até que eu interrompa
    speechRecognition.maxAlternatives = 1 // Somente uma alternativa de resultado
    speechRecognition.interimResults = true // Trazer os resultados conforme vou falando
